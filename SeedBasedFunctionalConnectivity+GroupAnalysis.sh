...
ROI="AN" #input your ROI mask name here. Corresponds to full name: Morel_${ROI}_2mm.nii.gz
...
###GROUP ANALYSIS###
ROI="intralaminar" #input your ROI mask name here.
stringCommand="3dttest -base1 0 -prefix t-test -set2 " #performs t-test on the follow set of data:
for subject in /home/despoB/connectome-thalamus/Thalamus_ROI_connectivity/headbrik_${ROI}/*; do
